...
| `remote-ci` (`.github/workflows/ci.yml`) | GitHub Actions at the release commit | **executed** | `fast` and `hdl` tiers passed at `b081d4bf53d9` (https://github.com/hareS1234/tetromino-circuit/actions/runs/34017474589) | `results/evidence/U20/remote_ci.json` |
